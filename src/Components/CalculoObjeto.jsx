...
function Calcular({impressao=0, pla=0, lucro = 30, material = 120, custoenergia = 0.94, salario = 1100.00, despesas = 80.00, primer = 18.00}) {
    ...
    valor = ((Aux_salariototal + Aux_despesas + Aux_totalmaterial + Aux_custoenergia + Aux_depreciacao) * (1 + (lucro * 0.01)) + (Tprimers * primer))
